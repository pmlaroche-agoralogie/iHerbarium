...
require_once ("scripts/url_parlante_arbres_se.inc");
$refTemplate = initTemplate("templates/systeme_expert_$gamme.html");
...
$valeurs_criteres = array(
	...
	"feuille" => array(
		"planesimplebordlisse" => 10,
		"planesimleborddentele" => 11,
		"lobe" => 12,
		"dente" => 13,
		"xe" => 3,
		"Entière" => 2
...
$valeurs_criteres = array(
        ...
        "feuille" => array(
                "simple" => 10,
                "planesimpleborddentele" => 11,
                "lobe" => 12,
                "dente" => 13,
                "folioles arrondies" => 15,
                "folioles denteees" =>16,
		 "folioles rayonantes" =>17,
 "aiguilles isolees" => 1,
                "aiguilles par 2 a 5" => 2,
                "aiguilles en bouquet" => 3,
                "--" =>4,
                 "petites ecailles" =>5,
 "grandes ecailles" =>6,
...
for($if=0;$if<20;$if++)
$poids_criteres['feuille'][$if][$if]=1;
...
global $url_parlante; 
	...
	else $url_construite = "arbres".$url_construite;
	// REECRITURE URL
...
function fct_titre_page ($mescriteres) {
	...
	if ($titre_page == "") $titre_page = "Un expert vous aide à identifier un arbre";
...
$infosPlantes['liste_arbre'] = fct_liste_fleurs ($mescriteres);

$infosPlantes['moteur_recherche'] = 
//Descriptif courant : '.
//$valeurs_criteres[feuilles][$mescriteres['feu']['code']]
'<br>feuilles planes <br>&nbsp;&nbsp;feuilles simples<br>
<a href=/arbres_feu~10.html>bord lisse</a> | <a href=/arbres_feu~11.html>bord dentele</a> | <a href=/arbres_feu~12.html>bord lobe</a> |  <a href=/arbres_feu~13.html>bord dente</a> 
<br>
&nbsp;&nbsp;feuilles composees<br>
<a href=/arbres_feu~15.html>folioles arrondies</a> | <a href=/arbres_feu~16.html>folioles denteles</a> | <a href=/arbres_feu~17.html>folioles rayonantes</a>
<br>
aiguilles ou ecailles <br>&nbsp;&nbsp;
<a href=/arbres_feu~1.html>aiguilles isolees</a> | 
<a href=/arbres_feu~2.html>aiguilles par 2 a 5</a> | 
<a href=/arbres_feu~3.html>aiguilles en bouquet</a> | 
<a href=/arbres_feu~5.html> petites ecailles</a> | 
<a href=/arbres_feu~6.html> grandes ecailles</a>

';
//print_r($mescriteres);
if(($mescriteres['feu']['code']== -1) ||($mescriteres['feu']['code']>100))
    {
    $sql = "SELECT * FROM  expertfeuille WHERE cas =  ".$mescriteres['feu']['code'] ;
    $result = mysql_query($sql, $connexion);
    
    $uncas = mysql_fetch_assoc($result) ;
    
    $infosPlantes['moteur_recherche'] = $uncas['codehtml'];
    }
