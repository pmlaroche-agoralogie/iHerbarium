...
floribalade.SpeakerStore = new Ext.data.Store({
    model: 'Speaker',
...
floribalade.views.SessionList = Ext.extend(Ext.Panel, {
    layout: 'card',
    groupByDay: true,
    ...
    initComponent: function() {
        ...
        floribalade.views.SessionList.superclass.initComponent.call(this);
    },
    ...
    initializeData: function(data) {
        ...
        floribalade.SpeakerStore.add.apply(floribalade.SpeakerStore, speakers);
        floribalade.SpeakerStore.sort('last_name');
    ...
    onSelect: function(selectionmodel, records){
        if (records[0] !== undefined) {
            var sessionCard = new floribalade.views.SessionDetail({
...
Ext.reg('sessionlist', floribalade.views.SessionList);
floribalade.views.SpeakerList = Ext.extend(Ext.Panel, {
    layout: 'card',
    ...
    initComponent: function() {
        ...
        this.list = new Ext.List({
            ...
            store: floribalade.SpeakerStore,
            listeners: {
        ...
        floribalade.views.SpeakerList.superclass.initComponent.call(this);
    },
    
    onSelect: function(sel, records){
        if (records[0] !== undefined) {
            
            var bioCard = new floribalade.views.SpeakerDetail({
                prevCard: this.listpanel,
                record: records[0]
            });
...
Ext.reg('speakerlist', floribalade.views.SpeakerList);
floribalade.views.HtmlPage = Ext.extend(Ext.Panel, {
    autoLoad: 'about.html',
    scroll: 'vertical',
    ...
    initComponent: function(){
        ...
        floribalade.views.HtmlPage.superclass.initComponent.call(this);
    }
});

Ext.reg('htmlpage', floribalade.views.HtmlPage);
floribalade.views.SpeakerDetail = Ext.extend(Ext.Panel, {
    scroll: 'vertical',
    ...
    initComponent: function(){
        ...
        floribalade.views.SpeakerDetail.superclass.initComponent.call(this);
    },
...
Ext.reg('speakerdetail', floribalade.views.SpeakerDetail);
floribalade.views.SessionDetail = Ext.extend(Ext.Panel, {
    scroll: 'vertical',
    layout: {
        type: 'vbox',
        align: 'stretch'
    ...
    initComponent: function(){
        this.dockedItems = [{
            ...
            // , {xtype: 'spacer'}, {
            //     iconCls: 'star',
            //     cls: 'favestar' + (floribalade.faveStore.find('proposal_id', this.record.data.id) == -1 ? '' : ' favorited'),
            //     iconMask: true,
            //     ui: 'plain',
            //     scope: this,
            //     handler: function(btn){
            //         var idx = floribalade.faveStore.find('proposal_id', this.record.data.id);
            //         if (idx == -1) {
            //             floribalade.faveStore.create({
            //                 proposal_id: this.record.data.id
            //             });
            //             btn.addCls('favorited');
            //         } else {
            //             floribalade.faveStore.removeAt(idx);
            //             floribalade.faveStore.sync();
        ...
        floribalade.views.SessionDetail.superclass.initComponent.call(this);
    },
    
    onSpeakerSelect: function(selectionmodel, records){
        if (records[0] !== undefined) {
            var speakerCard = new floribalade.views.SpeakerDetail({
                prevCard: this,
                record: records[0],
...
Ext.reg('SessionDetail', floribalade.views.SessionDetail);
...
floribalade.views.VideoList = Ext.extend(Ext.Panel, {
    layout: 'card',
    ...
    initComponent: function(){
        ...
        floribalade.views.VideoList.superclass.initComponent.call(this);
    },
...
Ext.reg('videolist', floribalade.views.VideoList);
floribalade.views.TweetList = Ext.extend(Ext.Panel, {
    hashtag: '',
    layout: 'fit',
    initComponent: function(){
        ...
        floribalade.views.TweetList.superclass.initComponent.call(this);
    },
...
Ext.reg('tweetlist', floribalade.views.TweetList);
