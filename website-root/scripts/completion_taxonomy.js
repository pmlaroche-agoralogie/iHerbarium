...
var _adresseRecherche = "scripts/completion_taxonomy.php" //l'adresse à interroger pour trouver les suggestions
...
function callSuggestions(valeur){
  ...
  if(_xmlHttp){
	 if (valeur.length < _minimum_caractere) { 
	   ...
	   if(_hiddenFieldSql!=null) { _xmlHttp.open("GET",_adresseRecherche+"?debut="+valeur+"&req="+_hiddenFieldSql,true); }
	   else { _xmlHttp.open("GET",_adresseRecherche+"?debut="+valeur,true); }
