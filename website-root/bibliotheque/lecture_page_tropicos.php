...
L\'equipe de iherbarium '),
  'es' => array(
        'mail_notif_subject' => 'Una respuesta fue haciendo sobre la observación :',
        'mail_notif_body'=> 'Un botánico ha respondido sobre la observación',
        'mail_notif_footer'=> 'Este programa está en fase de experimentación. Gracias a reportarnos cualquier anomalía o proponernos ningún cambio. \n El equipo de iherbarium.'
        ) ,
  'pt' => array(
		'mail_notif_subject' => 'iHerbarium : resposta na observação :',
		'mail_notif_body'=> 'Um botânico ou o sistema perito adicionam uma nota à observação ',
		'mail_notif_footer'=> 'Este Web site é ainda uma experiência, relate por favor todo o problema. \n equipe do iHerbarium'
		)
);
...
function preciser_determination($monobjet){
  ...
  if(isset($_POST['id_tropicos'])){
    $id_tropicos=$_POST['id_tropicos']; // on rÈcupËre l'identifiant entrÈ dans le formulaire par l'utilisateur
